...
export const env = createEnv({
  ...
  client: {
    ...
    NEXT_PUBLIC_LANGFUSE_PLAYGROUND_STREAMING_ENABLED_DEFAULT: z
      ...
      .optional()
      .default("true"),
    // 用于 Whistle 代理开发模式，强制使用指定的 base URL
  ...
  runtimeEnv: {
    ...
    LANGFUSE_S3_EVALUATION_MEDIA_BUCKET:
      process.env.LANGFUSE_S3_EVALUATION_MEDIA_BUCKET,
    LANGFUSE_S3_EVALUATION_MEDIA_PREFIX:
      process.env.LANGFUSE_S3_EVALUATION_MEDIA_PREFIX,
    LANGFUSE_S3_EVALUATION_MEDIA_REGION:
      process.env.LANGFUSE_S3_EVALUATION_MEDIA_REGION,
    LANGFUSE_S3_EVALUATION_MEDIA_ENDPOINT:
      process.env.LANGFUSE_S3_EVALUATION_MEDIA_ENDPOINT,
    LANGFUSE_S3_EVALUATION_MEDIA_ACCESS_KEY_ID:
      process.env.LANGFUSE_S3_EVALUATION_MEDIA_ACCESS_KEY_ID,
    LANGFUSE_S3_EVALUATION_MEDIA_SECRET_ACCESS_KEY:
      process.env.LANGFUSE_S3_EVALUATION_MEDIA_SECRET_ACCESS_KEY,
    LANGFUSE_S3_EVALUATION_MEDIA_FORCE_PATH_STYLE:
      process.env.LANGFUSE_S3_EVALUATION_MEDIA_FORCE_PATH_STYLE,
    // Worker
